...
//! [1]
void Editor::backgroundButtonGroupClicked(QAbstractButton *button)
{
...
//! [2]
void Editor::buttonGroupClicked(int id)
{
...
//! [4]
void Editor::pointerGroupClicked(int)
{
...
//! [7]
void Editor::itemInserted(DiagramItem *item)
{
...
//! [8]
void Editor::textInserted(QGraphicsTextItem *)
{
...
//! [9]
void Editor::currentFontChanged(const QFont &)
{
    handleFontChange();
}
//! [9]
...
//! [10]
void Editor::fontSizeChanged(const QString &)
{
    handleFontChange();
}
//! [10]
...
//! [11]
void Editor::sceneScaleChanged(const QString &scale)
{
...
//! [15]
void Editor::textButtonTriggered()
{
...
//! [16]
void Editor::fillButtonTriggered()
{
...
//! [17]
void Editor::lineButtonTriggered()
{
...
//! [19]
void Editor::itemSelected(QGraphicsItem *item)
{
...
//! [28]
QWidget *Editor::createBackgroundCellWidget(const QString &text,
                        const QString &image)
{
...
//! [29]
QWidget *Editor::createCellWidget(const QString &text,
...
//! [30]
QMenu *Editor::createColorMenu(const char *slot, QColor defaultColor)
{
    QList<QColor> colors;
...
//! [31]
QIcon Editor::createColorToolButtonIcon(const QString &imageFile,
                        QColor color)
{
...
//! [32]
QIcon Editor::createColorIcon(QColor color)
{
